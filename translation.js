    ...
    resources:{
        ...
        gr:{
            ...
            translation:{
                ...
                herotitle:"Το ταξίδι σας προς την άριστη γνώση της Αγγλικής γλώσσας ξεκινά εδώ. Μάθετε, αναπτυχθείτε και ακμάστε μαζί μας.",
                heropagr:"Απελευθερώστε το πλήρες δυναμικό σας με μαθήματα Αγγλικών καθοδηγούμενα από ειδικούς."+
                ...
                A:"Πετύχετε τους Στόχους Σας στην Αγγλικά με Αυτοπεποίθηση!",
